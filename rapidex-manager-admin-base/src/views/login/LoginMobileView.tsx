    ...
    <Box style={{ minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
      <Container size="xs" px="md">
        <Title ta="center" fw={900} size="xl">
          {i18next.t('rapidex-manager-admin-base:Seja Bem-vindo')}
        </Title>
        <Text c="dimmed" size="sm" ta="center" mt={5}>
          {i18next.t('rapidex-manager-admin-base:getStarted')}
        </Text>
        ...
        <Paper withBorder shadow="md" p={20} mt={30} radius="md">
          <Stack>
            ...
            <PasswordInput
              label={i18next.t('rapidex-manager-admin-base:Sua senha')}
            ...
            <Checkbox
              label={i18next.t('rapidex-manager-admin-base:Lembre-me')}
              checked={rememberMe}
            ...
            <Button 
              ...
              size="md"
            >
              {i18next.t('rapidex-manager-admin-base:signIn')}
            </Button>
          </Stack>
        </Paper>
      </Container>
