...
export class RapidexManagerAdminBaseUser extends ArchbaseUser {
  public id: string
...
@injectable()
export class RapidexManagerAdminBaseAuthenticator implements ArchbaseAuthenticator {
