...
exports.ARCHBASE_DEV_DEPENDENCIES = exports.ARCHBASE_OPTIONAL_DEPENDENCIES = exports.ARCHBASE_CORE_DEPENDENCIES = void 0;
exports.getProjectDependencies = getProjectDependencies;
exports.getFeatureDependencies = getFeatureDependencies;
exports.generatePackageJsonDependencies = generatePackageJsonDependencies;
exports.getMantinePostCSSConfig = getMantinePostCSSConfig;
exports.getMantineThemeSetup = getMantineThemeSetup;
/**
 * Core dependencies required by archbase-react
 * Based on archbase-react v2.1.3 package.json analysis
 */
exports.ARCHBASE_CORE_DEPENDENCIES = [
 ...
 */
exports.ARCHBASE_OPTIONAL_DEPENDENCIES = [
    // Rich text editing
 ...
 */
exports.ARCHBASE_DEV_DEPENDENCIES = [
    // TypeScript
 ...
 */
function getProjectDependencies(projectType = 'basic') {
    const coreDeps = exports.ARCHBASE_CORE_DEPENDENCIES.filter(dep => dep.required);
    const devDeps = exports.ARCHBASE_DEV_DEPENDENCIES.filter(dep => dep.required);
    let optionalDeps = [];
    switch (projectType) {
        case 'admin':
            // Include admin-specific dependencies
            optionalDeps = exports.ARCHBASE_OPTIONAL_DEPENDENCIES.filter(dep => ['@mui/x-data-grid', 'mantine-react-table', 'jwt-decode', 'js-cookie', 'file-saver', 'export-to-csv'].includes(dep.name));
            break;
        case 'full':
            // Include all optional dependencies
            optionalDeps = exports.ARCHBASE_OPTIONAL_DEPENDENCIES;
            break;
        default:
...
function getFeatureDependencies(features) {
    ...
    return exports.ARCHBASE_OPTIONAL_DEPENDENCIES.filter(dep => requiredDeps.includes(dep.name));
}
/**
 * Generate package.json dependencies section
 */
function generatePackageJsonDependencies(projectType = 'basic', additionalFeatures = []) {
 ...
 */
function getMantinePostCSSConfig() {
