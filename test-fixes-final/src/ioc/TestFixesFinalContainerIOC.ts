...
import { API_TYPE } from "./TestFixesFinalIOCTypes";
import { TestFixesFinalAuthenticator } from "../auth/TestFixesFinalAuthenticator";
...
IOCContainer.registerService(ARCHBASE_IOC_API_TYPE.Authenticator, TestFixesFinalAuthenticator);
